...
function loadHome() {
  ...
  const visaoInicial = document.getElementById(
    "visao-inicial-template"
  ).innerHTML;
        ...
        <div class="border-t border-slate-200">
          <details class="group">
            <summary class="group-hover:bg-slate-100 p-3 font-semibold text-sm ${
              ...
              <span>${
                disabled ? "Solução indisponível" : "Mostrar Solução"
              }</span>
            </summary>
            ${
              !disabled
                ? `<div class="p-4 bg-slate-800 text-white mono text-sm overflow-x-auto">
...
// Funções de inicialização de componentes (reutilizáveis)
